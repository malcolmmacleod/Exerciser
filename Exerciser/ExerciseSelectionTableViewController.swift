...
class ExerciseSelectionTableViewController: UITableViewController {
    ...
    let exercises : [String] = ["Running", "Walking", "Squats", "Pressups", "Star Jumps"]
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("Exercise Selection Cell", forIndexPath: indexPath) as! UITableViewCell
